var basemaps = (() => {
	...
	var l = (a, e) => _(a, "name", { value: e, configurable: !0 });
	var v = (a, e) => {
			for (var i in e) _(a, i, { get: e[i], enumerable: !0 });
		},
		j = (a, e, i, n) => {
	...
	var L = (a) => j(_({}, "__esModule", { value: !0 }), a);
	var $ = {};
	v($, {
		BLACK: () => h,
		DARK: () => p,
		...
		WHITE: () => m,
		get_country_name: () => d,
		get_multiline_name: () => o,
		language_script_pairs: () => g,
		layers: () => D,
		namedFlavor: () => S,
	});
	function t(a, e) {
		...
		return (
			a === "name"
				...
				: a === "name2"
					...
					: a === "name3" && (i = "script3"),
			[
				["coalesce", ["get", `pgf:${a}`], ["get", a]],
				{
					"text-font": [
						"case",
						["==", ["get", i], "Devanagari"],
						["literal", ["Noto Sans Devanagari Regular v1"]],
						["literal", [e || "Noto Sans Regular"]],
					],
				},
			]
		);
			...
			e === "Latin"
				...
				: a === "ja"
					? [
							"all",
							["!=", ["get", `script${n}`], "Han"],
							["!=", ["get", `script${n}`], "Hiragana"],
							["!=", ["get", `script${n}`], "Katakana"],
							["!=", ["get", `script${n}`], "Mixed-Japanese"],
						]
					: ["!=", ["get", `script${n}`], e]
		);
	}
	l(c, "is_not_in_target_script");
	function s(a) {
		return a === "Devanagari"
			? { "text-font": ["literal", ["Noto Sans Devanagari Regular v1"]] }
			: {};
	}
	l(s, "get_font_formatting");
	function u(a) {
		const e = g.find((i) => i.lang === a);
		return e === void 0 ? "Latin" : e.script;
	}
	l(u, "get_default_script");
	function d(a, e) {
		let i = e || u(a),
			n;
		return (
			i === "Devanagari" ? (n = "pgf:") : (n = ""),
			[
				"format",
				["coalesce", ["get", `${n}name:${a}`], ["get", "name:en"]],
				s(i),
			]
		);
	}
	l(d, "get_country_name");
	function o(a, e, i) {
		let n = e || u(a),
			r;
		return (
			n === "Devanagari" ? (r = "pgf:") : (r = ""),
			[
				"case",
				[
					"all",
				...
				[
					...
					[
						...
						[
							"format",
							["coalesce", ["get", `${r}name:${a}`], ["get", "name:en"]],
							s(n),
							`
`,
							{},
...
`,
				...
				[
					"case",
					["all", c(a, n, "name"), c(a, n, "name2"), c(a, n, "name3")],
					[
						"format",
						["get", `${r}name:${a}`],
						s(n),
...
`,
	...
	l(o, "get_multiline_name");
	var g = [
		{ lang: "ar", full_name: "Arabic", script: "Arabic" },
		{ lang: "cs", full_name: "Czech", script: "Latin" },
		{ lang: "bg", full_name: "Bulgarian", script: "Cyrillic" },
		{ lang: "da", full_name: "Danish", script: "Latin" },
		{ lang: "de", full_name: "German", script: "Latin" },
		{ lang: "el", full_name: "Greek", script: "Greek" },
		{ lang: "en", full_name: "English", script: "Latin" },
		{ lang: "es", full_name: "Spanish", script: "Latin" },
		{ lang: "et", full_name: "Estonian", script: "Latin" },
		{ lang: "fa", full_name: "Persian", script: "Arabic" },
		{ lang: "fi", full_name: "Finnish", script: "Latin" },
		{ lang: "fr", full_name: "French", script: "Latin" },
		{ lang: "ga", full_name: "Irish", script: "Latin" },
		{ lang: "he", full_name: "Hebrew", script: "Hebrew" },
		{ lang: "hi", full_name: "Hindi", script: "Devanagari" },
		{ lang: "hr", full_name: "Croatian", script: "Latin" },
		{ lang: "hu", full_name: "Hungarian", script: "Latin" },
		{ lang: "id", full_name: "Indonesian", script: "Latin" },
		{ lang: "it", full_name: "Italian", script: "Latin" },
		{ lang: "ja", full_name: "Japanese", script: "" },
		{ lang: "ko", full_name: "Korean", script: "Hangul" },
		{ lang: "lt", full_name: "Lithuanian", script: "Latin" },
		{ lang: "lv", full_name: "Latvian", script: "Latin" },
		{ lang: "ne", full_name: "Nepali", script: "Devanagari" },
		{ lang: "nl", full_name: "Dutch", script: "Latin" },
		{ lang: "no", full_name: "Norwegian", script: "Latin" },
		{ lang: "mr", full_name: "Marathi", script: "Devanagari" },
		{ lang: "mt", full_name: "Maltese", script: "Latin" },
		{ lang: "pl", full_name: "Polish", script: "Latin" },
		{ lang: "pt", full_name: "Portuguese", script: "Latin" },
		{ lang: "ro", full_name: "Romanian", script: "Latin" },
		{ lang: "ru", full_name: "Russian", script: "Cyrillic" },
		{ lang: "sk", full_name: "Slovak", script: "Latin" },
		{ lang: "sl", full_name: "Slovenian", script: "Latin" },
		{ lang: "sv", full_name: "Swedish", script: "Latin" },
		{ lang: "tr", full_name: "Turkish", script: "Latin" },
		{ lang: "uk", full_name: "Ukrainian", script: "Cyrillic" },
		{ lang: "ur", full_name: "Urdu", script: "Arabic" },
		{ lang: "vi", full_name: "Vietnamese", script: "Latin" },
		{ lang: "zh-Hans", full_name: "Chinese (Simplified)", script: "Han" },
		{ lang: "zh-Hant", full_name: "Chinese (Traditional)", script: "Han" },
	];
	function y(a, e) {
		return [
			{
				id: "background",
				type: "background",
				paint: { "background-color": e.background },
			},
			{
				id: "earth",
				type: "fill",
				...
				? [
						{
							...
							paint: {
								"fill-color": [
									...
									["get", "kind"],
									"grassland",
									e.landcover.grassland,
									"barren",
									e.landcover.barren,
									"urban_area",
									e.landcover.urban_area,
									"farmland",
									e.landcover.farmland,
									"glacier",
									e.landcover.glacier,
									"scrub",
									e.landcover.scrub,
			...
			},
			{
				...
				paint: { "fill-color": e.park_b, "fill-opacity": 0.7 },
			},
			{
				id: "landuse_hospital",
				type: "fill",
			...
			},
			{
				...
				paint: { "line-color": e.water, "line-width": 0.5 },
			},
			{
				id: "water_river",
				type: "line",
			...
			},
			{
				...
				paint: {
					"line-color": e.tunnel_other_casing,
					"line-gap-width": [
						"interpolate",
						["exponential", 1.6],
						["zoom"],
			...
			},
			{
				...
				paint: {
					"line-color": e.tunnel_minor_casing,
					"line-dasharray": [3, 2],
					"line-gap-width": [
						"interpolate",
						["exponential", 1.6],
			...
			},
			{
				...
				paint: {
					"line-color": e.tunnel_link_casing,
					"line-dasharray": [3, 2],
					"line-gap-width": [
						"interpolate",
						["exponential", 1.6],
			...
			},
			{
				...
				paint: {
					"line-color": e.tunnel_major_casing,
					"line-dasharray": [3, 2],
					"line-gap-width": [
						"interpolate",
						["exponential", 1.6],
			...
			},
			{
				...
				paint: {
					"line-color": e.tunnel_highway_casing,
			...
			},
			{
				...
				paint: { "fill-color": e.buildings, "fill-opacity": 0.5 },
			},
			{
				id: "roads_pier",
				type: "line",
			...
			},
			{
				...
				paint: {
					"line-color": e.minor_service_casing,
					"line-gap-width": [
						"interpolate",
						["exponential", 1.6],
						["zoom"],
			...
			},
			{
				...
				paint: {
					"line-color": e.major_casing_late,
					"line-gap-width": [
						"interpolate",
						["exponential", 1.6],
						["zoom"],
			...
			},
			{
				...
				paint: {
					"line-color": e.highway_casing_late,
					"line-gap-width": [
						"interpolate",
						["exponential", 1.6],
						["zoom"],
			...
			},
			{
				...
				paint: {
					"line-color": e.major_casing_early,
					"line-gap-width": [
						"interpolate",
						["exponential", 1.6],
						["zoom"],
			...
			},
			{
				...
				paint: {
					"line-color": e.highway_casing_early,
					"line-gap-width": [
						"interpolate",
						["exponential", 1.6],
						["zoom"],
			...
			},
			{
				...
				paint: {
					"line-color": e.bridges_other_casing,
					"line-gap-width": [
						"interpolate",
						["exponential", 1.6],
						["zoom"],
			...
			},
			{
				...
				paint: {
					"line-color": e.bridges_minor_casing,
					"line-gap-width": [
						"interpolate",
						["exponential", 1.6],
						["zoom"],
			...
			},
			{
				...
				paint: {
					"line-color": e.bridges_major_casing,
					"line-gap-width": [
						"interpolate",
						["exponential", 1.6],
						["zoom"],
			...
			},
			{
				...
				paint: {
					"line-color": e.bridges_highway_casing,
					"line-gap-width": [
						"interpolate",
						["exponential", 1.6],
						["zoom"],
		...
		return [
			{
				...
				layout: {
					...
					"text-font": [e.italic || "Noto Sans Italic"],
					"text-field": ["get", "addr_housenumber"],
					"text-size": 12,
				},
				paint: {
					"text-color": e.address_label,
					"text-halo-color": e.address_label_halo,
					"text-halo-width": 1,
				},
			},
			{
				...
				layout: {
					...
					"text-font": [e.italic || "Noto Sans Italic"],
					"text-field": o(i, n, e.regular),
					"text-size": 12,
					"text-letter-spacing": 0.2,
				},
				paint: {
					"text-color": e.ocean_label,
					"text-halo-color": e.water,
					"text-halo-width": 1,
				},
			},
			{
				...
				layout: {
					...
					"symbol-placement": "line",
					"text-font": [e.regular || "Noto Sans Regular"],
					"text-field": o(i, n, e.regular),
					"text-size": 12,
				},
				paint: {
					"text-color": e.roads_label_minor,
					"text-halo-color": e.roads_label_minor_halo,
					"text-halo-width": 1,
				},
			},
			{
			...
			},
			{
				...
				paint: {
					"text-color": e.subplace_label,
					"text-halo-color": e.subplace_label_halo,
					"text-halo-width": 1,
				},
			},
			{
			...
			},
			{
				...
				paint: {
					"text-color": e.roads_label_major,
					"text-halo-color": e.roads_label_major_halo,
					"text-halo-width": 1,
				},
			},
			...(e.pois
			...
			},
			{
				...
				paint: {
					"text-color": e.state_label,
					"text-halo-color": e.state_label_halo,
					"text-halo-width": 1,
				},
			},
			{
				...
				layout: {
					...
					"text-font": [
						"case",
						["<=", ["get", "min_zoom"], 5],
						["literal", [e.bold || "Noto Sans Medium"]],
						["literal", [e.regular || "Noto Sans Regular"]],
					],
					"symbol-sort-key": [
						"case",
						["has", "sort_key"],
				...
				paint: {
					"text-color": e.city_label,
					"text-halo-color": e.city_label_halo,
					"text-halo-width": 1,
				},
			},
			{
				...
				layout: {
					...
					"text-field": d(i, n),
					"text-font": [e.bold || "Noto Sans Medium"],
					"text-size": [
						"interpolate",
						["linear"],
						["zoom"],
	...
	function D(a, e, i) {
		let n = [];
		return (
			(i != null && i.labelsOnly) || (n = y(a, e)),
			i != null && i.lang && (n = n.concat(k(a, e, i.lang))),
			n
		);
	}
	l(D, "layers");
