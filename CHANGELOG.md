...
- add seperate build-node-version parameter (c53f016)

### 🐛 Fixes

- use wss when using https (bf47cd4)
- windows paths (33f1fbb)
- keep the .git folder from the build (27caf15)

### ♻️ Refactors

- ingestion is a shared component - so cant use window.location here (d9c93c8)
- switch to build-once strategy (d8bb4e9)

### 🧹 Chores

- tweak changelog format (c22285a)
- bump the minor-and-patch group with 9 updates (8eb0860)
- update gh actions versions (844d413)
- test ci with node 20 (bed146c)
- testing ci changes (5070118)
- testing ci changes (f72caaf)
...
- | --- | --- | --- | (8eb0860)
- | [@lucide/svelte](https://github.com/lucide-icons/lucide/tree/HEAD/packages/svelte) | `1.24.0` | `1.25.0` | (8eb0860)
- | [@emnapi/wasi-threads](https://github.com/toyobayashi/emnapi) | `2.0.0` | `2.0.1` | (8eb0860)
- | [@tailwindcss/vite](https://github.com/tailwindlabs/tailwindcss/tree/HEAD/packages/@tailwindcss-vite) | `4.3.2` | `4.3.3` | (8eb0860)
- | [eslint-plugin-svelte](https://github.com/sveltejs/eslint-plugin-svelte/tree/HEAD/packages/eslint-plugin-svelte) | `3.20.0` | `3.21.0` | (8eb0860)
- | [lucide-static](https://github.com/lucide-icons/lucide) | `1.24.0` | `1.25.0` | (8eb0860)
- | [prettier-plugin-tailwindcss](https://github.com/tailwindlabs/prettier-plugin-tailwindcss) | `0.8.0` | `0.8.1` | (8eb0860)
- | [svelte](https://github.com/sveltejs/svelte/tree/HEAD/packages/svelte) | `5.56.4` | `5.56.6` | (8eb0860)
- | [tailwindcss](https://github.com/tailwindlabs/tailwindcss/tree/HEAD/packages/tailwindcss) | `4.3.2` | `4.3.3` | (8eb0860)
- | [vite](https://github.com/vitejs/vite/tree/HEAD/packages/vite) | `8.1.4` | `8.1.5` | (8eb0860)
- Updates `@lucide/svelte` from 1.24.0 to 1.25.0 (8eb0860)
- - [Release notes](https://github.com/lucide-icons/lucide/releases) (8eb0860)
- - [Commits](https://github.com/lucide-icons/lucide/commits/1.25.0/packages/svelte) (8eb0860)
- Updates `@emnapi/wasi-threads` from 2.0.0 to 2.0.1 (8eb0860)
- - [Release notes](https://github.com/toyobayashi/emnapi/releases) (8eb0860)
- - [Commits](https://github.com/toyobayashi/emnapi/compare/wasi-threads-v2.0.0...wasi-threads-v2.0.1) (8eb0860)
- Updates `@tailwindcss/vite` from 4.3.2 to 4.3.3 (8eb0860)
- - [Release notes](https://github.com/tailwindlabs/tailwindcss/releases) (8eb0860)
- - [Changelog](https://github.com/tailwindlabs/tailwindcss/blob/main/CHANGELOG.md) (8eb0860)
- - [Commits](https://github.com/tailwindlabs/tailwindcss/commits/v4.3.3/packages/@tailwindcss-vite) (8eb0860)
- Updates `eslint-plugin-svelte` from 3.20.0 to 3.21.0 (8eb0860)
- - [Release notes](https://github.com/sveltejs/eslint-plugin-svelte/releases) (8eb0860)
- - [Changelog](https://github.com/sveltejs/eslint-plugin-svelte/blob/main/packages/eslint-plugin-svelte/CHANGELOG.md) (8eb0860)
- - [Commits](https://github.com/sveltejs/eslint-plugin-svelte/commits/eslint-plugin-svelte@3.21.0/packages/eslint-plugin-svelte) (8eb0860)
- Updates `lucide-static` from 1.24.0 to 1.25.0 (8eb0860)
- - [Release notes](https://github.com/lucide-icons/lucide/releases) (8eb0860)
- - [Commits](https://github.com/lucide-icons/lucide/compare/1.24.0...1.25.0) (8eb0860)
- Updates `prettier-plugin-tailwindcss` from 0.8.0 to 0.8.1 (8eb0860)
- - [Release notes](https://github.com/tailwindlabs/prettier-plugin-tailwindcss/releases) (8eb0860)
- - [Changelog](https://github.com/tailwindlabs/prettier-plugin-tailwindcss/blob/main/CHANGELOG.md) (8eb0860)
- - [Commits](https://github.com/tailwindlabs/prettier-plugin-tailwindcss/compare/v0.8.0...v0.8.1) (8eb0860)
- Updates `svelte` from 5.56.4 to 5.56.6 (8eb0860)
- - [Release notes](https://github.com/sveltejs/svelte/releases) (8eb0860)
- - [Changelog](https://github.com/sveltejs/svelte/blob/main/packages/svelte/CHANGELOG.md) (8eb0860)
- - [Commits](https://github.com/sveltejs/svelte/commits/svelte@5.56.6/packages/svelte) (8eb0860)
- Updates `tailwindcss` from 4.3.2 to 4.3.3 (8eb0860)
- - [Release notes](https://github.com/tailwindlabs/tailwindcss/releases) (8eb0860)
- - [Changelog](https://github.com/tailwindlabs/tailwindcss/blob/main/CHANGELOG.md) (8eb0860)
- - [Commits](https://github.com/tailwindlabs/tailwindcss/commits/v4.3.3/packages/tailwindcss) (8eb0860)
- Updates `vite` from 8.1.4 to 8.1.5 (8eb0860)
- - [Release notes](https://github.com/vitejs/vite/releases) (8eb0860)
- - [Changelog](https://github.com/vitejs/vite/blob/main/packages/vite/CHANGELOG.md) (8eb0860)
- - [Commits](https://github.com/vitejs/vite/commits/v8.1.5/packages/vite) (8eb0860)
- --- (8eb0860)
- updated-dependencies: (8eb0860)
- - dependency-name: "@lucide/svelte" (8eb0860)
- dependency-version: 1.25.0 (8eb0860)
- dependency-type: direct:production (8eb0860)
- update-type: version-update:semver-minor (8eb0860)
- dependency-group: minor-and-patch (8eb0860)
- - dependency-name: "@emnapi/wasi-threads" (8eb0860)
- dependency-version: 2.0.1 (8eb0860)
- dependency-type: direct:development (8eb0860)
- update-type: version-update:semver-patch (8eb0860)
- dependency-group: minor-and-patch (8eb0860)
- - dependency-name: "@tailwindcss/vite" (8eb0860)
- dependency-version: 4.3.3 (8eb0860)
- dependency-type: direct:development (8eb0860)
- update-type: version-update:semver-patch (8eb0860)
- dependency-group: minor-and-patch (8eb0860)
- - dependency-name: eslint-plugin-svelte (8eb0860)
- dependency-version: 3.21.0 (8eb0860)
- dependency-type: direct:development (8eb0860)
- update-type: version-update:semver-minor (8eb0860)
- dependency-group: minor-and-patch (8eb0860)
- - dependency-name: lucide-static (8eb0860)
- dependency-version: 1.25.0 (8eb0860)
- dependency-type: direct:development (8eb0860)
- update-type: version-update:semver-minor (8eb0860)
- dependency-group: minor-and-patch (8eb0860)
- - dependency-name: prettier-plugin-tailwindcss (8eb0860)
- dependency-version: 0.8.1 (8eb0860)
- dependency-type: direct:development (8eb0860)
- update-type: version-update:semver-patch (8eb0860)
- dependency-group: minor-and-patch (8eb0860)
- - dependency-name: svelte (8eb0860)
- dependency-version: 5.56.6 (8eb0860)
- dependency-type: direct:development (8eb0860)
- update-type: version-update:semver-patch (8eb0860)
- dependency-group: minor-and-patch (8eb0860)
- - dependency-name: tailwindcss (8eb0860)
- dependency-version: 4.3.3 (8eb0860)
- dependency-type: direct:development (8eb0860)
- update-type: version-update:semver-patch (8eb0860)
- dependency-group: minor-and-patch (8eb0860)
- - dependency-name: vite (8eb0860)
- dependency-version: 8.1.5 (8eb0860)
- dependency-type: direct:development (8eb0860)
- update-type: version-update:semver-patch (8eb0860)
- dependency-group: minor-and-patch (8eb0860)
- ... (8eb0860)
- Signed-off-by: dependabot[bot] <support@github.com> (8eb0860)
